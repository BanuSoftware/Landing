...
function Valores({title, content_left, content_right, icon}) {
  return (
    <div className="group relative overflow-hidden rounded-2xl p-4 transition-all duration-500 hover:scale-105 ]">
      {/* Animación*/}
      <div className="absolute -top-1/2 -left-1/2 w-[200%] h-[200%] -rotate-45 opacity-0 transition-all duration-500 ease-in-out group-hover:opacity-100 group-hover:translate-y-full pointer-events-none"></div>
